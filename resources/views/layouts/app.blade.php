      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ url( route('offer.index') ) }}"><i class="fa fa-list"></i> <span>{{__('lang.offers')}}</span></a></li>
         ...
         <!-- <ul class="treeview-menu">-->
          <!--</ul>-->  
        {{-- <li><a href="#"><i class="fa fa-list"></i> {{__('lang.categories')}}</a></li>
        <li><a href="#"><i class="fa fa-users"></i> <span>{{__('lang.clients')}}  </span></a></li>
        <li><a href="#"><i class="fa fa-address-card"></i><span>{{__('lang.contacts')}}</span></a></li>
        <li><a href="#"><i class="fa fa-book"></i> <span>{{__('lang.setting')}}</span></a></li>
        @role('admin')
        <li><a href="#"><i class="fa fa-book"></i> <span>{{__('lang.users')}}</span></a></li>
        <li><a href="#"><i class="fa fa-book"></i> <span>{{__('lang.roles')}}</span></a></li>
        @endrole
        <li><a href="#"><i class="fa fa-book"></i> <span>{{__('lang.change password')}}</span></a></li> --}} --}}
